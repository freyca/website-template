...
<h2 id="accordion-collapse-heading-{{ $id }}">
    <button type="button"
        class="flex items-center justify-between w-full p-5 bg-white font-medium border border-gray-200 rounded hover:bg-gray-100 gap-3"
