...
<div
    ...
    <div class="relative pb-48 overflow-hidden">
        ...
        <div
            class="absolute inset-0 bg-gradient-to-b from-slate-700 to-transparent bg-opacity-70 flex items-center justify-center text-center opacity-0 group-hover:opacity-100 transition duration-300">
            <a href="{{ $path . '/' . $product->slug }}">
                <div class="mx-auto text-center">
                    <p class="text-white opacity-90 mx-4 mb-4 text-sm sm:text-base">
