<div id="search-bar-container" class="container mx-auto flex justify-between items-center" style=" display: block;    width: 80%; margin-top: 1em;">
    <form role="search" style="    width: 100%;    float: inline-end;">
        ...
        <div class="relative  md:block " style="    float: inline-end;    text-align: center;width: 100%; ">
            ...
            <input wire:model.live="searchTerm" type="search" id="search-navbar" aria-label="Search" class="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="{{ __('Search') }}...">
        </div>
